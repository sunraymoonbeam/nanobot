...
class Dream:
    ...
    _PHASE1_SYSTEM = (
        "Compare the conversation history against current memory files. "
        "Identify what needs to change.\n\n"
        "Output one line per finding in this format:\n"
        "[FILE] atomic fact or change description\n\n"
        "Files:\n"
        "- USER: identity, preferences, habits, communication style\n"
        "- SOUL: behavioral rules for the bot, tone adjustments\n"
        "- MEMORY: reusable knowledge, project context, tool patterns\n\n"
        "Rules:\n"
        "- Only new or conflicting information — skip duplicates and ephemera "
        "(weather, greetings, one-off queries)\n"
        "- Prefer atomic facts: \"has a cat named Luna\" not \"discussed pet care\"\n"
        "- If existing info is wrong, note the correction: "
    ...
    _PHASE2_SYSTEM = (
        ...
        "- SOUL.md: bot behavioral rules, personality\n"
        "- MEMORY.md: reusable knowledge, project context\n\n"
        "## Quality standards\n"
        "- Every line must carry standalone value — no filler\n"
        "- Concise bullet points under clear headers\n"
        "- Remove outdated or contradicted information\n"
        "- No ephemeral data (today's weather, one-time queries)\n\n"
        "## Editing\n"
